...
MODEL_ID = "Wizard-Vicuna-13B-Uncensored"
WEIGHTS_URL = "https://weights.replicate.delivery/default/thebloke/Wizard-Vicuna-13B-Uncensored-HF/model.tar"
...
class Predictor(BasePredictor):
    ...
    def predict(
        ...
        max_new_tokens: int = Input(
            ...
            default=DEFAULT_MAX_NEW_TOKENS, ge=1, le=2048
        ),
